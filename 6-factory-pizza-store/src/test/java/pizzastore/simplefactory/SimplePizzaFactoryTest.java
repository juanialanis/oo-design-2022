...
public class SimplePizzaFactoryTest {
  ...
  public void createFactoryTest(){
    assertNotNull(new SimplePizzaFactory());
  }
  ...
  public void createPizzaTest(String type, Class<Pizza> pizzaClass) {
    ...
    assertEquals(factory.createPizza(type).getClass(),pizzaClass);
  }

  @Test
  public void pizzaNotExistTest(){
    SimplePizzaFactory factory = new SimplePizzaFactory();
    assertThrows(IllegalArgumentException.class, ()-> factory.createPizza("pizza not exist"));
  }
}
