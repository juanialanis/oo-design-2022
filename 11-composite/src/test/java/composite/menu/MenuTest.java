...
public class MenuTest {
    ...
    @Test
    public void breakfastMenuTest() {
        breakfastMenu.add(cakesMenu);
        breakfastMenu.add(cafeMenu);
    }

    @Test
    public void pancakeHouseMenuTest() {
